...
public class ExerciseDetailsDto
{
    ...
    public List<string> BodyPartsRu { get; set; } = [];
    public List<string> PrimaryMuscles { get; set; } = [];
    public List<string> PrimaryMusclesRu { get; set; } = [];
    public List<string> SecondaryMuscles { get; set; } = [];
    public List<string> SecondaryMusclesRu { get; set; } = [];
    public List<string> Equipments { get; set; } = [];
    public List<string> EquipmentsRu { get; set; } = [];
