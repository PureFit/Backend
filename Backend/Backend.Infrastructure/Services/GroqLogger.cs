...
public class GroqLogger
{
    ...
    public GroqLogger()
    {
        _logDirectory = Path.Combine(Directory.GetCurrentDirectory(), "logs", "groq");
    ...
    {
        var filePath = Path.Combine(_logDirectory, $"groq_{DateTime.UtcNow:yyyy-MM-dd}.log");
