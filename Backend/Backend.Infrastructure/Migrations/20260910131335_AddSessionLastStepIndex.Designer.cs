...
namespace Backend.Infrastructure.Migrations
{
    ...
    [Migration("20260910131335_AddSessionLastStepIndex")]
    partial class AddSessionLastStepIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.Core.Entities.AchievementRelated.Achievement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Backend.Core.Entities.AchievementRelated.UserAchievement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("UserInfoId", "AchievementId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Backend.Core.Entities.TrainingRelated.AIPlan", b =>
                {
                    ...
                    b.Property<List<string>>("AvailableEquipment")
                        .IsRequired()
                        .HasColumnType("jsonb");
                    ...
                    b.Property<string>("FreeTextWish")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Backend.Core.Entities.TrainingRelated.SetLike", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TrainingSetId", "UserId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Backend.Core.Entities.TrainingRelated.UserWorkloadStat", b =>
                {
                    ...
                    b.Property<float>("AccumulatedVolume")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("Backend.Core.Entities.UserFriendship", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Backend.Infrastructure.Persistence.ExerciseEmbeddingRecord", b =>
                {
                    ...
                    b.ToTable("exercise_embeddings", (string)null);
                });

            modelBuilder.Entity("Backend.Core.Entities.AchievementRelated.UserAchievement", b =>
                {
                    b.HasOne("Backend.Core.Entities.AchievementRelated.Achievement", "Achievement")
            ...
            modelBuilder.Entity("Backend.Core.Entities.UserFriendship", b =>
                {
                    b.HasOne("Backend.Core.Entities.User", "Addressee")
                        .WithMany()
                        .HasForeignKey("AddresseeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Backend.Core.Entities.User", "Requester")
                        .WithMany()
